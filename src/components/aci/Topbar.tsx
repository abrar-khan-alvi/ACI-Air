...
export function Topbar({ onMenu }: { onMenu: () => void }) {
  return (
    <header className="bg-aci-blue-800 sticky top-0 z-30 flex min-h-14 items-center gap-1.5 border-b border-white/10 px-3 py-2 sm:gap-3 sm:px-6 sm:py-2.5 lg:px-8">
      <button
        onClick={onMenu}
