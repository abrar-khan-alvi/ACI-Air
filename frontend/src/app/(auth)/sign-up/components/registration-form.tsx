            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-2">
                  <Select id="dialCode" {...partnerForm.register("dialCode")} className="w-1/3" aria-invalid={!!partnerForm.formState.errors.dialCode}>
                  ...
                  <Input id="phone" className="w-2/3" placeholder="Number" {...partnerForm.register("phone")} aria-invalid={!!partnerForm.formState.errors.phone} />
                </div>
                {(partnerForm.formState.errors.phone || partnerForm.formState.errors.dialCode) && <span className="text-xs text-red-500 ml-1 font-medium">{partnerForm.formState.errors.phone?.message || partnerForm.formState.errors.dialCode?.message}</span>}
              </div>
              <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Select id="currency" {...partnerForm.register("currency")} aria-invalid={!!partnerForm.formState.errors.currency}>
                ...
                {partnerForm.formState.errors.currency && <span className="text-xs text-red-500 ml-1 font-medium">{partnerForm.formState.errors.currency.message}</span>}
              </div>
            </div>
