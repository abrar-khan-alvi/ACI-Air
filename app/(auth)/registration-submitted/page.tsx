    ...
    <div className="w-full max-w-[560px]">
      <div className="bg-card shadow-[0_16px_40px_rgb(0_59_36_/_12%)] rounded-2xl p-8 md:p-12 text-center">
        ...
        <p className="text-muted-foreground mb-8">
          Thank you for applying to partner with ACI Air. Your registration is currently under
          review. We will notify you via email once your account has been approved.
        </p>
