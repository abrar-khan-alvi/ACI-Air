    ...
    <div className="sign-in-page w-full max-w-[480px] perspective-1000">
      <div className="sign-in-card backdrop-blur-xl bg-white/70 border border-white/50 shadow-[0_30px_60px_-15px_rgba(0,166,81,0.15)] rounded-3xl p-8 sm:p-10 transform-gpu transition-all duration-500 hover:shadow-[0_40px_80px_-20px_rgba(0,166,81,0.2)]">
        ...
        <div className="sign-in-social flex flex-col gap-3 mb-8">
          ...
          <Button
            variant="outline"
            className="h-12 w-full flex items-center justify-center gap-3 bg-white/80 border-slate-200 hover:bg-[#1877F2]/5 hover:border-[#1877F2]/30 hover:text-[#1877F2] hover:shadow-md transition-all duration-300 text-slate-700 font-semibold rounded-xl group relative overflow-hidden"
          >
            <svg
              viewBox="0 0 24 24"
              width="22"
              height="22"
              xmlns="http://www.w3.org/2000/svg"
              className="group-hover:scale-110 transition-transform duration-300 text-[#1877F2]"
            >
              <path
